About py-readability-metrics-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-readability-metrics-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12899&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-readability-metrics-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-readability-metrics` can be installed with `conda`:
...
```
mamba install py-readability-metrics
```

It is possible to list all of the versions of `py-readability-metrics` available on your platform with `conda`:
...
```
mamba search py-readability-metrics --channel conda-forge
```
...
mamba repoquery search py-readability-metrics --channel conda-forge

# List packages depending on `py-readability-metrics`:
mamba repoquery whoneeds py-readability-metrics --channel conda-forge

# List dependencies of `py-readability-metrics`:
mamba repoquery depends py-readability-metrics --channel conda-forge
```
